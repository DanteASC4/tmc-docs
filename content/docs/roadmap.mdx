...
Framework specific exports like `import { barchart } from 'nanocharts/svelte'` I think would be great as it could allow for framework specific utilization. I'm not 100% sure how this works, but I know this is nearly a requirement for usage for a lot of things I bet.
